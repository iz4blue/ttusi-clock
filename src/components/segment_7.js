...
function getStyle(value) {
  switch(value) {
    case 0: return styles.displayNo0
    case 1: return styles.displayNo1
    case 2: return styles.displayNo2
    case 3: return styles.displayNo3
    case 4: return styles.displayNo4
    case 5: return styles.displayNo5
    case 6: return styles.displayNo6
    case 7: return styles.displayNo7
    case 8: return styles.displayNo8
    case 9: return styles.displayNo9
    default:
